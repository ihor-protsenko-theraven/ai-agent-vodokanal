import { AgentProcessingResult, TicketDuplicate } from '@/shared/types';
import { aiConfig, nlpConfig, speechConfig, wsnConfig } from '@/shared/config';
...
import { QuestionGenerator } from '@/features/voice/domain/nlp/QuestionGenerator';
import { formatDateTimeLocal, generateCallId } from '@/shared/utils/wsn';
